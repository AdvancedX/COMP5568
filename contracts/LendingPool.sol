...
contract LendingPool {
    ...
    uint256 private immutable i_slope1PerBlock;
    uint256 private immutable i_slope2PerBlock;
    uint256 private immutable i_kinkUtilization;
    ...
    uint256 private s_lastAccrualBlock;

    uint256 private s_totalScaledSupply;
    uint256 private s_totalScaledDebt;

    mapping(address => uint256) private s_scaledSupply;
    mapping(address => uint256) private s_scaledDebt;
